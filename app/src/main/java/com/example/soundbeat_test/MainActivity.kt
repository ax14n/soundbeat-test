...
fun MainApp() {
    ...
    AppNavigation(
        navController = navController, sharedPlaylistViewModel = sharedPlaylistViewModel
    )
}
...
@Composable
fun AppNavigation(
    navController: NavHostController, sharedPlaylistViewModel: SharedPlaylistViewModel
) {
